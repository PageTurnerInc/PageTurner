...
from katalog_buku.views import show_katalog, show_book_page, add_book_katalog, get_product_json, delete_book_katalog, add_book_to_rak, show_json, add_book_katalog_flutter, remove_book_katalog_flutter
...
urlpatterns = [
    ...
    path('remove-book-katalog-flutter/', remove_book_katalog_flutter, name='remove-book-katalog-flutter'),
]